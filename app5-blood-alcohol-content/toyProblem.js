...
function bloodAlcoholContent(drinks, weight, sex, time){
  var alcoholContent = drinks.ounces * drinks.abv * 5.14
  var timePassed = .015 * time
  if( sex === 'female' ) {
    return Number(((alcoholContent / weight * 0.66) - timePassed).toFixed(4))
  } else if( sex === 'male' ) {
    return Number(((alcoholContent / weight * 0.73) - timePassed).toFixed(4))
  }
  }
